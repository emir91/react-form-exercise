...
import { FormData } from "../ContactForm/types";
    ...
    function useValidation<T extends Record<string, string>> (initialValues: T, validationConfig: ValidationConfig) {
        ...
        const areFieldsEmpty = (inputValues: FormData): boolean => Object.values(inputValues).some(value => value === '');

        
        return {values, setValues, errors, handleChange, handleBlur, areFieldsEmpty};
    }
